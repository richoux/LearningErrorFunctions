...
int main(int argc, char **argv)
{
	...
	cout << "Loading data done. Start estimating metrics.\n";
	...
	for( auto tuple : cost_map )
	{
		...
		auto cost_hamming = static_cast<int>( tuple.second.first );
		auto cost_manhattan = static_cast<int>( tuple.second.second );
