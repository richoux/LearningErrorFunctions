...
\textsuperscript{\rm 1}National Institute for Informatics\\ %If you have multiple authors and multiple affiliations
...
\begin{enumerate}
\item Formalisation WCSP vs CFN (section 5 du draft). Mettre les refs.
\item CP est  difficile à modéliser, CFN ajoute une  structure utile au
  ...
  d'une sélection fine des bonnes contraintes.
...
\item Verrous techniques (section 6)  sur comment passer à l'échelle :
  4 propositions et 4 inconvénients/impossibilités.
\item Modèle CFN + XP si j'arrive à quelque chose en pratique.
