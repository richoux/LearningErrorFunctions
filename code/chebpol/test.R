...
data <- read.csv(file="all-diff_4.csv")
hamming <- c(data[,1])
manhattan <- c(data[,2])
mix <- c(data[,3])
...
data <- read.csv(file="all-diff_5.csv")
hamming <- c(data[,1])
manhattan <- c(data[,2])
mix <- c(data[,3])
...
data <- read.csv(file="all-diff_6.csv")
hamming <- c(data[,1])
manhattan <- c(data[,2])
mix <- c(data[,3])
...
data <- read.csv(file="less_than_3.csv")
hamming <- c(data[,1])
manhattan <- c(data[,2])
mix <- c(data[,3])
...
data <- read.csv(file="less_than_4.csv")
hamming <- c(data[,1])
manhattan <- c(data[,2])
mix <- c(data[,3])
...
data <- read.csv(file="less_than_5.csv")
hamming <- c(data[,1])
manhattan <- c(data[,2])
mix <- c(data[,3])
