...
double AllDiff::required_cost() const
{
	...
	// l
	vector<double> coeff{3, 0, 7, 2, 1, 6, 5, 1, 1, 2, 0, 2, 8, 2, 6, 0, 0, 1, 4, 1, 3, 4, 4, 8, 1, 2, 7, 2, 0, 7, 5, 6, 4, 7, 1, 8, 3, 3, 4, 7, 6, 4, 8, 6, 1, 0, 0, 7, 4, 2, 6, 5, 3, 2, 4, 4, 1, 8, 4, 5, 3, 5, 3, 4, 6, 7, 6, 7, 4, 8, 6, 4, 4, 0, 3, 0, 7, 3, 0, 3, 5, 5, 8, 0, 4, 4, 0, 4, 1, 4};
