...
{
	int number_units_compar = ( (int)raw_weights.size() - number_units_agreg ) - number_units_transfo;
	vector<int> network_weights( number_units_compar * number_units_transfo + number_units_agreg, 0 );
...
{
	int number_units_compar = ( (int)weights.size() - number_units_agreg ) / number_units_transfo;
	vector<int> raw_weights( number_units_compar + number_units_transfo + number_units_agreg, 0 );
	...
	std::copy( std::prev( weights.end(), number_units_agreg ),
	           weights.end(),
